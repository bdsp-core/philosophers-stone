...
import sys
import os
sys.path.insert(0, os.path.expanduser('~/repos/sleep_cognition/pytorch-image-models/'))
sys.path.insert(0, os.path.expanduser('~/repos/sleep_cognition/pytorch-image-models/timm/'))

from models.maxxvit import *
from models.maxxvit import _rw_max_cfg, cfg_window_size, MaxxVitStage, _init_conv
from models._registry import generate_default_cfgs, register_model
from models._manipulate import named_apply, checkpoint_seq
from models._features_fx import register_notrace_function
from models._builder import build_model_with_cfg
from layers import RelPosMlp, RelPosBias, RelPosBiasTf, use_fused_attn
from layers import trunc_normal_tf_, to_2tuple, extend_tuple, make_divisible, _assert
from layers import create_attn, get_act_layer, get_norm_layer, get_norm_act_layer, create_conv2d, create_pool2d
from layers import Mlp, ConvMlp, DropPath, LayerNorm, ClassifierHead, NormMlpClassifierHead, NormMlpClassifierHead2
